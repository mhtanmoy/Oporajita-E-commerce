...
urlpatterns = [
    ...
    path('product-category-delete/<pk>/',
         views.ProductCategoryDelete.as_view(), name='product-category-delete'),
    ...
    path('brand-delete/<pk>/', views.BrandDelete.as_view(),
    ...
    path('product-size-delete/<pk>/', views.ProductSizeVariantDelete.as_view(),
         name='product-size-delete'),
    path('product-inventory/', views.ProductInventoryListDetail.as_view(),
    ...
    path('bulk-inventory-entry/', views.BulkInventoryEntryUpdate.as_view(),
         name='bulk-inventory-entry-list'),
    ...
    path('purchase-update/<int:pk>/',
         views.PurchasePaymentView.as_view(), name='purchase-update'),
