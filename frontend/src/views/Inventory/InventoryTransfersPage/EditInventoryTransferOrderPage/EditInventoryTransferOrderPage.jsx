...
function EditInventoryTransferOrderPage() {
  //   states
      ...
      <div className="page-container">
        ...
        >
          <div className="row">
                  ...
                  <div className="row">
                    ...
                    <div className="mb-3 col-md-3">
                      ...
                      >
                        ...
                        <option value="Dhanmondi Main Outlet">
                          Dhanmondi Main Outlet
                        </option>
                        <option value="Chittagong Outlet">
                          Chittagong Outlet
                        </option>
                      </select>
                    </div>
            ...
            <div className="col-3">
              <div className="panel-container">
                <div className="status-contaienr">
                  <Circle className="feather-icon-sm" />
                  {previousData.status}
                </div>
              </div>
            </div>
...
export default EditInventoryTransferOrderPage;
