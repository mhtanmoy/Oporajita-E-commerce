...
function EditCouponPage() {
  ...
  async function sendData(payload, e) {
    ...
    try {
      const response = await axiosInstance.put(`api/v1/app/promocode/${couponID}/`, payload,config);
  ...
  async function getCoupon() {
    ...
    try {
      const response = await axiosInstance.get(`api/v1/app/promocode/${couponID}/`,config);
